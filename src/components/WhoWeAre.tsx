    ...
    <section className="w-full pt-[40px] pb-[80px] px-6 md:px-10 max-w-content mx-auto">
        ...
        <div className="w-full md:max-w-[600px]">
          <Reveal delay={0.1}>
            ...
            <div className="flex gap-8">
              <a
                href="#contact"
                className="font-sans text-[12px] font-medium text-black border-b border-black/20 hover:border-black pb-0.5 transition-colors"
              >
                Get in touch &rarr;
              </a>
              <a
      ...
      <div className="w-full border-t border-gray-100 pt-12">
        <InfiniteMarquee
          ...
          renderItem={(logo) => (
            <span
              className={`text-[24px] md:text-[28px] text-black whitespace-nowrap opacity-40 grayscale hover:opacity-100 transition-opacity duration-300 ${logo.font}`}
            >
              {logo.name}
            </span>
          )}
