      ...
      <div className="w-full max-w-content px-6 md:px-10 mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-12 gap-x-[24px] mb-24">
          ...
          <div className="flex flex-col gap-4">
            <h4 className="font-sans font-bold text-[12px] uppercase tracking-wider text-black mb-2">
              BROWSE
            </h4>
            <Link
              to="/"
              className="font-sans text-[13px] text-black hover:opacity-60 transition-opacity"
            >
              Home
            </Link>
            <Link
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              href="mailto:hello@yellowstudio.com"
              className="font-sans text-[13px] text-black hover:opacity-60 transition-opacity"
            >
              Email us
            </a>
          ...
          <div className="flex flex-col gap-4">
            ...
            <span className="font-sans text-[13px] text-gray-400 mt-2">
              © 2025
            </span>
          </div>
        </div>
