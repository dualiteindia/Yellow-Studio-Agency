...
const WorkItem: React.FC<WorkItemProps> = ({
  ...
  <Link
    to={`/work/${id}`}
    className={cn("flex flex-col gap-4 group w-full cursor-pointer", className)}
  >
    <Reveal>
      <div
        className={cn(
  ...
  return (
    <section className="w-full max-w-content px-6 md:px-10 mx-auto pb-24 pt-12">
      ...
      <div className="flex justify-between items-baseline w-full mb-[64px]">
        ...
        <Link
          to="/work"
          className="font-sans text-[13px] font-medium text-black hover:opacity-60 transition-opacity"
        >
          All work &rarr;
        </Link>
      </div>
