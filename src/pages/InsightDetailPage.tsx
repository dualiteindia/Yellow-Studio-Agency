            ...
            <div className="w-full md:w-1/3 md:max-w-[300px] border-t border-gray-200">
              <Reveal delay={0.1}>
                <div className="flex justify-between py-3 border-b border-gray-100">
                  <span className="font-sans text-[11px] font-bold uppercase tracking-wider text-black">
                    CATEGORY
                  </span>
                  <span className="font-sans text-[11px] font-medium bg-gray-100 px-2 py-0.5 rounded text-black">
                    {article.category}
                  </span>
                </div>
                <div className="flex justify-between py-3 border-b border-gray-100">
          ...
          <div className="flex flex-col gap-12">
            ...
            <Reveal delay={0.1}>
              ...
              <div className="flex flex-col gap-8">
                <div>
                  <h3 className="font-sans font-black text-[18px] uppercase tracking-wide text-black mb-2">
