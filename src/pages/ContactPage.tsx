              ...
              <form className="flex flex-col gap-8">
                ...
                <Reveal delay={0.1}>
                  <div className="flex flex-col gap-4">
                    <label className="font-sans text-[12px] font-bold uppercase tracking-wide text-black">
                      ABOUT YOU
                    </label>
                    <input
                      type="text"
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-8">
              ...
              <Reveal>
                <div className="flex justify-between items-baseline border-b border-gray-100 pb-4">
                  <span className="font-sans text-[12px] font-bold uppercase tracking-wide text-black">
                    NEW BUSINESS
                  </span>
                  <a
                    href="mailto:business@yellowstudio.com"
                    className="font-sans text-[14px] text-black hover:opacity-60 transition-opacity underline decoration-gray-300 underline-offset-4"
                  >
                    business@email.com
                  </a>
                </div>
              ...
              <Reveal delay={0.1}>
                <div className="flex justify-between items-baseline border-b border-gray-100 pb-4">
                  ...
                  <a
                    href="mailto:hi@yellowstudio.com"
                    className="font-sans text-[14px] text-black hover:opacity-60 transition-opacity underline decoration-gray-300 underline-offset-4"
                  >
                    hi@email.com
                  </a>
              ...
              <Reveal delay={0.2}>
                <div className="flex justify-between items-start border-b border-gray-100 pb-4">
                  <span className="font-sans text-[12px] font-bold uppercase tracking-wide text-black mt-1">
                    DROP IN
                  </span>
        ...
        <div className="w-full max-w-content px-6 md:px-10 mx-auto mb-[120px]">
          <InfiniteMarquee
            ...
            renderItem={(name, index) => (
              <span
                key={index}
                className="text-[24px] md:text-[28px] text-black whitespace-nowrap font-bold font-sans"
              >
                {name}
              </span>
            )}
