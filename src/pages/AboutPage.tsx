  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans">
      ...
      <main className="w-full flex-grow flex flex-col items-center">
        ...
        <section className="w-full mb-[120px]">
          ...
          <div className="w-full max-w-content px-6 md:px-10 mx-auto flex flex-col md:flex-row gap-12">
            <div className="w-full md:w-1/4">
              <h2 className="font-sans font-black text-[13px] uppercase tracking-wider text-black">
                MISSION
              </h2>
            </div>
            ...
            {TEAM.map((member, i) => (
              <Reveal key={i} delay={i * 0.1}>
                <div className="flex flex-col">
                  ...
                  <h3 className="font-sans font-bold text-[13px] uppercase tracking-wide text-black mb-1">
                    {member.name}
                  </h3>
                  <span className="font-sans text-[11px] font-medium text-gray-500 uppercase tracking-wider">
                    {member.role}
                  </span>
                </div>
              </Reveal>
        ...
        <section className="w-full max-w-content px-6 md:px-10 mx-auto mb-[120px]">
          <div className="mb-16 max-w-xl">
            <h2 className="font-sans font-black text-[32px] md:text-[48px] uppercase tracking-tight text-black mb-6">
              OUR APPROACH
            </h2>
            ...
            {APPROACH.map((step, i) => (
              <Reveal key={step.id} delay={i * 0.1}>
                <div className="flex flex-col border-t border-gray-100 pt-6">
                  <span className="font-sans text-[11px] font-bold text-gray-400 mb-4">
                    {step.id}
                  </span>
                  <h3 className="font-sans font-black text-[24px] uppercase tracking-tight text-black mb-4">
                    {step.title}
                  </h3>
